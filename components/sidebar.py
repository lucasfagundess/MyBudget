...
layout = dbc.Col([
    ...
    html.P("By Lucas Fagundes", className="text-info"),
    html.Hr(),

    # sessão PERFIL -------------------
    dbc.Button(id='botao-avatar',
               children=[html.Img(src='/assets/img_hom.png', id='avatar_change', alt='Avatar', className='perfil_avatar')
                         ], style={'background-color': 'transparent', 'boarder-color': 'transparent'}),
                            ...
                            dbc.Col([
                                ...
                                dbc.Checklist(
                                    ...
                                    label_checked_style={
                                        'color': 'red'},
                                    input_checked_style={
                                        'backgroundColor': 'blue', 'boarderColor': 'orange'}
                                ),
                                dbc.Button(
    ...
    ], style={"background-color": "rgba(17, 140, 79, 0.05)"}, id="modal-novo-receita",
        size="lg",
        is_open=False,
        centered=True,
        backdrop=True),
    ...
    ], style={"background-color": "rgba(17, 140, 79, 0.05)"}, id="modal-novo-despesa",
        size="lg",
        is_open=False,
        centered=True,
        backdrop=True),
